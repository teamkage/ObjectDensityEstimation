...
<video id="epoch" height="auto" width="740" src="data/epoch.mp4" controls onclick="this.paused ? this.play() : this.pause();"></video>
...
<video id="results" height="auto" width="740" src="data/results.mp4" controls onclick="this.paused ? this.play() : this.pause();"></video>
